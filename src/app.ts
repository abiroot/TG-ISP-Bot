...
import { searchActivityFlow } from '~/features/admin/flows/SearchActivityFlow'
...
import { customerPingAPFlow } from '~/features/isp/flows/CustomerPingAPFlow'
import { customerPingStationFlow } from '~/features/isp/flows/CustomerPingStationFlow'
...
async function main() {
    ...
    const flows = [
        ...
        // Search activity flow (admin-only)
        searchActivityFlow,
